set CLASSPATH="C:\Documents and Settings\kterada\infinispan-quickstart\clustered-cache\target\classes"
set DEPEND=C:\Documents and Settings\kterada\infinispan-quickstart\clustered-cache\target\dependency
...
rem java -classpath %CLASSPATH% org.infinispan.quickstart.clusteredcache.distribution.Node0
java -classpath %CLASSPATH% org.infinispan.quickstart.clusteredcache.replication.Node0
